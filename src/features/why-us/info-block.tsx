...
export const InfoBlock: React.FC<Props> = ({title, text, logo, styles}) => {
    return (
        <div className={`flex flex-col ${styles} py-[42px] px-[51px] w-[720px] gap-[25px] border-[1px] text-[#0A131D] text-[24px] leading-[32px] font-medium rounded-[15px] border-[#CCE5F8]`}>
            <LogoBlock logo={logo}/>
            <h3>{title}</h3>
