    ...
    return (
        <div className="flex md:flex-row flex-col items-center xl:gap-[50px] gap-[30px]">
            <div className="flex  justify-between relative xl:w-[858px] mdbvp:w-[650px] sml:w-[500px] w-full mdbvp:h-[970px] md:h-[818px] h-[650px] flex-col border-[1px] rounded-[15px] border-[#BEDAE9]">
                <div className="flex flex-col gap-[25px] py-[36px] sml:px-[50px] px-[20px] items-start">
                    <div className="flex flex-col gap-[25px] sml:w-[396px] w-full">
                        <div className="flex w-[42px] text-[22px] h-[42px] items-center p-2 justify-center bg-[#0A131D0D] rounded-[5px] border-[1px] border-[#AFC0D0]">
                            1
                        </div>
                ...
                <Image className="z-[10] sml:px-[90px] px-[20px]" src={smile} alt="/"/>
                <div className="absolute bottom-0 z-[5] w-full mdbvp:h-[500px] h-[300px] bg-gradient-to-b from-white to-blue-200 rounded-lg shadow-md p-6"></div>
            </div>
            <div className="flex flex-col xl:gap-[50px] gap-[30px]">
                <div className="flex xl:w-[572px] mdbvp:w-[470px] md:w-[400px] sml:w-[500px] w-full items-center relative flex-col border-[1px] rounded-[15px] border-[#BEDAE9]">
                    <div className="flex flex-col mdbvp:gap-[25px] gap-[10px] mdbvp:py-[36px] md:py-[15px] md:pt-0 pt-[51px] items-start">
                        <div className="flex flex-col mdbvp:gap-[25px] gap-[10px] mdbvp:px-0 px-[20px] sml:w-[396px] w-full">
                            <div className="flex w-[42px] text-[22px] h-[42px] items-center p-2 justify-center bg-[#0A131D0D] rounded-[5px] border-[1px] border-[#AFC0D0]">
                                2
                            </div>
                    ...
                    <Image className="z-[10] sml:px-0 px-[20px]" src={sphere} alt="/"/>
                    <div className="absolute bottom-0 z-[5] w-full sml:h-[200px] h-[150px] bg-gradient-to-b from-white to-blue-200 rounded-lg shadow-md p-6"></div>
                </div>
                <div className="flex xl:w-[572px] mdbvp:w-[470px] md:w-[400px] sml:w-[500px] w-full items-center relative flex-col border-[1px] rounded-[15px] border-[#BEDAE9]">
                    ...
                    <Image className="z-[10] sml:px-0 px-[20px]" src={flower} alt="/"/>
                    <div className="absolute bottom-0 z-[5] w-full sml:h-[200px] h-[150px] bg-gradient-to-b from-white to-blue-200 rounded-lg shadow-md p-6"></div>
                </div>
            </div>
        </div>
